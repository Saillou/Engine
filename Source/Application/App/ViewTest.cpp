    ...
    BaseScene(widthHint, heightHint)
{
    ...
    // Configuration
    cook.addRecipe(Cookable::CookType::Shadow);
    Shader& shader = *cook.get(Cookable::CookType::Shadow);
...
void ViewTest::draw() {
    ...
    m_shadowRender.render(m_camera, lightPos, [=](Shader& sh) {
        renderScene(sh);
    });
    ...
    BaseScene::clear();
    {
        ...
        shader.set("viewPos", m_camera.position);
        shader.set("far_plane", m_camera.far_plane);
