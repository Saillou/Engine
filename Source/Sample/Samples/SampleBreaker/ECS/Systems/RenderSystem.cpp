...
void RenderSystem::loadModels()
{
    ...
    m_gameModels[Breaker::ModelId::CubeBasic].model->localPose = glm::scale(glm::mat4(1.0f), glm::vec3(0.2f, 0.2f, 0.2f));
    ...
    m_gameModels[Breaker::ModelId::SphereBasic].model->localPose = glm::scale(glm::mat4(1.0f), glm::vec3(0.2f));
}
...
void RenderSystem::update(Renderer& renderer)
{
    ...
    for (auto& entity : m_entities)
    {
        ...
        m_batchedPoses[renderComponent.modelId][m_batchIdMap[entity]] = { transform.getMat4() * gameModel.model->localPose };
...
void RenderSystem::addEntity(Entity entity)
{
    ...
    m_batchedPoses[renderComponent.modelId].push_back(transform.getMat4() * gameModel.model->localPose);
