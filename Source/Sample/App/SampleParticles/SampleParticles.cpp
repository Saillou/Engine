    ...
    m_scene(Service<Window>::get().scene())
{
    ...
    m_entities["particle"].setPosesWithMaterials(
        { 
            glm::translate(glm::scale(glm::mat4(1.0f), glm::vec3(0.25f)), glm::vec3(-2.5f,0,0)),
            glm::translate(glm::scale(glm::mat4(1.0f), glm::vec3(0.25f)), glm::vec3(+0.0f,0,0)),
            glm::translate(glm::scale(glm::mat4(1.0f), glm::vec3(0.25f)), glm::vec3(+2.5f,0,0)),
        },
        { 
            { glm::vec4(0.2f, 0.7f, 0.5f, 0.9f), false },
            { glm::vec4(0.2f, 0.7f, 0.7f, 0.9f), false },
